...
export interface IOnboardingGroupTaskProps {
    showDialog: boolean;
    handleNo: any;
    handleYes: any;
    clientId: string;
...
export interface IOnboardingGroupTaskState {
    filter: undefined;
    dataState?: any;
    data: any;
    total?: any;
...
export default class OnboardingGroupTask extends Component<IOnboardingGroupTaskProps, IOnboardingGroupTaskState> {
    constructor(props) {
        super(props);
