...
export interface ReqApproverGroupTaskProps {
    showDialog: boolean;
    handleNo: any;
    handleYes: any;
    clientId: string;
...
export interface ReqApproverGroupTaskState {
    filter: undefined;
    dataState?: any;
    data: any;
    total?: any;
...
export default class ReqApproverGroupTask extends Component<ReqApproverGroupTaskProps, ReqApproverGroupTaskState> {
    constructor(props) {
        super(props);
