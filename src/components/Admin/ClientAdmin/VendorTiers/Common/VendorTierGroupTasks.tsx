...
export interface IVendorTierGroupTaskProps {
    showDialog: boolean;
    handleNo: any;
    handleYes: any;
    clientId: string;
...
export interface IVendorTierGroupTaskState {
    filter: undefined;
    dataState?: any;
    data: any;
    total?: any;
...
export default class ReleaseGroupTask extends Component<IVendorTierGroupTaskProps, IVendorTierGroupTaskState> {
    constructor(props) {
        super(props);
                                ...
                                <div className="row ml-0 mr-0 mt-2 mb-2 mt-lg-3 mb-lg-3">
                                    ...
                                    >
                                        ...
                                        <GridColumn
                                            field="tier"
                                            title="Vendor Tier"
                                            cell={(props) => CellRender(props, "Vendor Tier")}
                                            columnMenu={WithoutFilterColumnMenu}
                                            filter="text"
                                            filterable={false}
                                            sortable={false}
