...
export interface InterviewCriteriaGroupTaskProps {
    showDialog: boolean;
    handleNo: any;
    handleYes: any;
    clientId: string;
...
export interface InterviewCriteriaGroupTaskState {
    filter: undefined;
    dataState?: any;
    data: any;
    total?: any;
...
export default class InterviewCriteriaGroupTask extends Component<InterviewCriteriaGroupTaskProps, InterviewCriteriaGroupTaskState> {
    constructor(props) {
        super(props);
