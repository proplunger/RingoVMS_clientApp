...
import { GLOBAL_SETTINGS_UPDATE_SUCCESS_MSG, SAVE_CLIENT_SETTING_CONFIRMATION_MSG } from "../../../Shared/AppMessages";
...
> {
    ...
    getData = () => {
        ...
        GlobalService.getGlobalSetting().then((res) => this.setState({ data: res.data, showLoader: false }))
    };
    ...
    SaveSettings = () => {
        ...
        GlobalService.patchGlobalSetting(data)
            .then(() => {
                successToastr(GLOBAL_SETTINGS_UPDATE_SUCCESS_MSG);
                this.getData();
                ...
                <div className="col-12 p-10 shadow pt-1 pb-1">
                    ...
                    <div className="row mb-2 mb-lg-4 ml-sm-0 mr-sm-0">
                        <div className="col-12 mt-5 text-sm-center text-center font-regular">
                            ...
                            <button type="button" className="btn button button-close mr-2 mb-2 mb-xl-0 shadow" onClick={() => history.goBack()}>
                                <FontAwesomeIcon icon={faTimesCircle} className={"mr-1"} />
                                    Close
                                </button>
                            {(
                                <button type="button" className="btn button button-bg mr-2 mb-2  mb-xl-0 shadow" disabled={this.state.saveDisabled} onClick={(e) => this.setState({ showConfirmationModal: true })}>
