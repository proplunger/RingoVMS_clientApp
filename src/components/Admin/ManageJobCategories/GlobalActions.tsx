...
export const ActiveSelected = () => {
    return (
        <div className="pb-1 pt-1 w-100 myorderGlobalicons">
            <FontAwesomeIcon icon={faCheckCircle} className={"nonactive-icon-color ml-2 mr-2"}></FontAwesomeIcon> Active Selected{" "}
        </div>
    );
};

export const InActiveSelected = (InActive) => {
    return (
        <div className="pb-1 pt-1 w-100 myorderGlobalicons" onClick = {InActive}>
            <FontAwesomeIcon icon={faTimesCircle} className={"nonactive-icon-color ml-2 mr-2"}></FontAwesomeIcon> In-Active Selected{" "}
        </div>
    );
};
...
export const AddNewJobCategory = (Add) => {
    return (
        <div className="pb-1 pt-1 w-100 myorderGlobalicons" onClick = {Add}>
            
            <FontAwesomeIcon icon={faPlusCircle} className={"nonactive-icon-color ml-2 mr-2"}></FontAwesomeIcon> Add Job Category{" "}
        </div>
    );
};

export const CustomMenu = (excelData , Add, Remove, InActive) => {
    return (
        <Menu openOnClick={true} className="actionItemMenu actionItemMenuThreeDots">
            <MenuItem render={MenuRender}>
                <MenuItem render={() => AddNewJobCategory(Add)} />
                <MenuItem render={Import} disabled/>
                <MenuItem render={DownloadTemplate} disabled />
                <MenuItem render={ActiveSelected} disabled/>
                <MenuItem render={() => InActiveSelected(InActive)} />
