...
export interface IconMessageModalProps {
  showModal: boolean;
  message: any;
  handleNo: any;
...
export interface IconMessageModalState {
  showModal: boolean;
...
export class IconMessageModal extends React.Component<
  IconMessageModalProps,
  IconMessageModalState
> {
...
export default IconMessageModal;
