...
export interface TemporaryModalState {
 ...
 class TemporaryModal extends React.Component<
  TemporaryModalProps,
  TemporaryModalState
> {
  constructor(props) {
  ...
  getReasons() {
    axios
      .get(`api/candidates/action/${this.props.actionId}/reasons`)
      .then((res) => {
  ...
  handleYes = () => {
    const { comments, reasonId, showError , expirationDate} = this.state;
    let showErrors =
      comments =="" || reasonId =="" || reasonId ==null ? true : false;
    this.setState({ showError: showErrors });
    if (!showErrors) {
      this.props.handleYes({ reasonId, expirationDate, comments });
    }
  };
          ...
          <div className="containerDialog bg-primaryyy">
            <div className="containerDialog-animation">
              <div className="col-11 col-sm-8 col-md-6 col-lg-4 shadow containerDialoginside containerDialoginside-popup">
                ...
                <div className="col-12 col-sm-11 mx-auto mt-2 mt-sm-0 mt-lg-3">
